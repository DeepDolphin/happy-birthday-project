...
#define NUM_SONGS 3
const struct MusicSong song_list[NUM_SONGS] = {
	//Test Song
	...
	{.music_tracks = (struct MusicTrack[]) {
		...
		}, .playback_type = PLAYBACK_MONO, .length = 564},
		{.music_chords = (struct MusicChord[]) {
			{.music_notes = (struct MusicNote[]) {
		...
		}, .playback_type = PLAYBACK_MONO, .length = 596},
		{.music_chords = (struct MusicChord[]) {
			{.music_notes = (struct MusicNote[]) {
		...
		}, .playback_type = PLAYBACK_MONO, .length = 194},
		{.music_chords = (struct MusicChord[]) {
			{.music_notes = (struct MusicNote[]) {
		...
		}, .playback_type = PLAYBACK_MONO, .length = 2}
	}, .num_tracks = 4}
};
